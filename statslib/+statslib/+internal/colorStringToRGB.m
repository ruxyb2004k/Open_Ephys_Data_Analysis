...
%
%   Examples:
%   >> clrRGB = statslib.internal.colorStringToRGB('rgb')
%   clrRGB =
%      1     0     0
%      0     1     0
%      0     0     1
%   >> clrRGB = statslib.internal.colorStringToRGB({'r','blue','m'})
%   clrRGB =
%      1     0     0
%      0     0     1
%      1     0     1
%   >> clrRGB = statslib.internal.colorStringToRGB({'red'})
%   clrRGB = 1     0     0
...
for i = 1:numClrs
    clr = clrString{i};
    clr = statslib.internal.getParamVal(clr,[ColorStrShort,ColorStrLong],...
        '''Color''');
