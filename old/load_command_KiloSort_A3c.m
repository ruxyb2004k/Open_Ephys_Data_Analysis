...
experimentName = '2021-04-22_12-05-13'
sessionName = 'V1_20210422_1'
...
recordingDepth = [-540 -550]'; % !!! Modify for each experiment !!!
channelNo = 64;
probe = '2x32_H6';% '1x16_P1' '2x16_E1'
animal.name = '20210414_RV1';
animal.sex = 'm';
...
clearvars -except timeSeries med range1 channelNo dataPoints sessionInfo filenameSessionInfo filenameTimeSeries experimentName sessionName basePathKilosort basePathData chOffset dataEv timestampsEv ts 
%%
