...
filenameSpikeClusterData = fullfile(basePathMatlab,'spikeClusterData1.mat'); % general info about the session
...
%spikeClusterData.trialsForAnalysisSelected = [2:10,12:16]; %% delete from here
...
% spikeClusterData.trialsForAnalysisSelected = timeSeries.trialsForAnalysis([1:7,12:20])
